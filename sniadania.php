    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active ">
            <a class="nav-link active" href="login.php"> <i class="bi bi-eye"> <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="card-footer">
              ...
              <a href="error.php"><button type="button" class="btn btn-link" >+</button></a>
            </div>
          </div>
        </div>
      </div>
