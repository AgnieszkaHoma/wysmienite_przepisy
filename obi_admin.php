        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu " aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="sniadanieadmin.php">Śniadania</a>
              <a class="dropdown-item" href="obiadadmin.php">Obiady</a>
              <a class="dropdown-item" href="kolacjaadmin.php">Kolacje</a>
